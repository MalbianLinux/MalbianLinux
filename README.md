...
Also, since Malbian is in an Alpha state, we are open to changes and modifications to best suit our needs. You can actually participate, ask or suggest for tools to be added into Malbian's images in our [Discord Server](https://discord.gg/2t6DSVSn) 
